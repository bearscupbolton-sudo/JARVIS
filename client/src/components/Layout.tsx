...
const ALL_SHORTCUT_OPTIONS: NavItem[] = [
  ...
  { href: "/par-yield-registry", label: "Par & Yield Registry", icon: ListChecks },
  { href: "/production-matrix", label: "Production Matrix", icon: BarChart3 },
  { href: "/sell-out-history", label: "Sell-Out History", icon: ClipboardList },

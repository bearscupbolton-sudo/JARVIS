...
export const squareCatalogMap = pgTable("square_catalog_map", {
  ...
  pastryItemId: integer("pastry_item_id"),
  targetType: text("target_type").default("pastry").notNull(),
  coffeeDrinkId: integer("coffee_drink_id"),
  coffeeDrinkName: text("coffee_drink_name"),
  locationId: integer("location_id"),
  isActive: boolean("is_active").default(true).notNull(),
  createdAt: timestamp("created_at").defaultNow(),
});
...
export const squareDailySummary = pgTable("square_daily_summary", {
  ...
  cashTender: doublePrecision("cash_tender").notNull().default(0),
...
export const wholesaleCustomers = pgTable("wholesale_customers", {
  ...
  state: text("state"),
  zip: text("zip"),
  certificateOfAuthority: text("certificate_of_authority"),
  st120FilePath: text("st120_file_path"),
  st120IsBlanket: boolean("st120_is_blanket").default(false),
  locationId: integer("location_id"),
  createdAt: timestamp("created_at").defaultNow(),
});

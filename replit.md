...
### Lamination Studio
This module tracks the full lifecycle of lamination doughs, assigning sequential numbers for identification. It manages dough creation, folding steps (with optional chilling), resting, and destination assignment (Proof Box, Freezer, Fridge). It includes a multi-pastry shaping feature, allowing multiple pastry types from a single dough, and comprehensive editing capabilities for doughs at various stages.
